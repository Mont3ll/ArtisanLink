  ...
  return (
    <nav className="sticky top-0 z-50 bg-stone-50/95 backdrop-blur-sm border-b border-stone-200">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/" className="text-2xl font-serif font-bold text-emerald-800">ChapaWorks</Link>
        <div className="flex items-center gap-4">
          <Link href="/artisans" className="text-sm text-stone-600 hover:text-emerald-700 transition-colors hidden sm:block">Browse Artisans</Link>
