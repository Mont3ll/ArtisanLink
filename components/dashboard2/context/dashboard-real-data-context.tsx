...
function ArtisanProvider({
  ...
  const value: DashboardRealData = {
    ...
    artisanJobs: jobs,
    artisanPortfolio: projects,
    artisanEarnings: earningRows,
...
function NonArtisanProvider({
  ...
  const value: DashboardRealData = {
    ...
    artisanProfile: null,
    conversations: role === "admin" ? null : threads,
    ...
    adminUsers: role === "admin" ? adminUsersList : null,
    adminModerationRows: role === "admin" ? adminModerationList : null,
    adminInvites: role === "admin" ? adminInvitesList : null,
    ...
    clientJobs: role === "client" ? realClientJobs : null,
